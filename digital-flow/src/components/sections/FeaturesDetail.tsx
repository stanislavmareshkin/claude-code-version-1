...
const FeatureContent = styled.div<{ $reversed: boolean }>`
  @media (min-width: ${({ theme }) => theme.breakpoints.mobile}) {
    order: ${({ $reversed }) => ($reversed ? 2 : 1)};
  }
`;

const FeatureVisual = styled.div<{ $reversed: boolean }>`
      ...
      <PageHeader>
        <Container>
          <AnimatedSection>
            ...
            <PageDescription>
              Everything your team needs to manage work, automate workflows, and collaborate
              effectively.
            </PageDescription>
          </AnimatedSection>
        </Container>
